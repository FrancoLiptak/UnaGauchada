...
?>
    ...
    <div class="row">
      <div class="container">
        <div class="page-header">
          <h2>Visualiza todas las publicaciones hasta el momento y comienza a participar! <a href="gauchadas.php" class="center-block btn btn-info" style="display:inline;" id="ver"> <span class="glyphicon glyphicon-globe"></span> Gauchadas </a></h2>
