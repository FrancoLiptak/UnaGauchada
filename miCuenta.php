<li class="dropdown">
	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img class="img-circle img-nav-user"src="<?php echo $photo ?>">&nbsp;<?php echo $name." ".$surname;?><span class="caret"></span></a>
