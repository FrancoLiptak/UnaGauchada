          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                  ...
                  <li>
                    <a href="#">
                      <form id="search" name="gauchadas" action="gauchadas.php?titulo=titulo&cat=cat&city=city" method="get">
                        ...
                        <input type="submit" id="submit" name="ir" value="Filtrar" class="btn btn-warning ir btn-block">
                      </form>
                    </a>
                  </li>
                </ul>
              ...
              <?php } include_once "miCuenta.php"; 
                  if (!($_SESSION['admin'])) { ?>
              <li><a target="_self"><span class="glyphicon glyphicon-piggy-bank"></span> <?php echo $credits; if($credits == 1) echo " crédito"; else echo " créditos"; ?> </a></li>
              <?php }
} ?>
            </ul>
