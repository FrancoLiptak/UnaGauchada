...
<head>
  ...
  <?php
  /* 
  sebas: para hacer codigo php para borrar un logro anda al form .form-eliminar para ver como se manda el idLogros en un input hidden a eliminarlogro.php. Para el editar anda al form .form-editar para ver como se manda el idLogros en un input hidden junto con los otros datos a editarLogro.php. 
  ...
  Primero, estamos usando pop ups (mas precisamente divs de la clase modal) y se complico un poco el pasaje de parametros a estos. Lo que hago es que, al hacer click en el boton que abre el modal para editar/borrar la logro particular, disparar una funcion js (que esta en este archivo abajo de todo) que lo que hace es asignar el data-id del boton presionado (que va a ser la concatenacion: id/nombre del logro al que esta asociado el boton en el caso de eliminar, y id/nombre/min para editar) al elemento html dentro del body del modal que tenga el id que yo le digo en la funcion (ver abajo).
  NOTAS:
    -Es importante notar los botones para elimnar y editar deben tener el att data-id="<datos del logro>".
    -Como en la funcion js lo que hago es cambiar el value de un elemento dentro del modal-body, ese elemento debe ser un input, li, option entre otros; es decir, algun elemento html que tenga el att value. De todos los elementos que tienen value me sirve el input, es por eso que el nombre del logro en el modal para eliminar se ve en un input text disabled, y necesito crear un form para que se envie el id del logro en un input hidden idLogros al apretar 'Si, deseo eliminar'. ESTO ES IMPORTANTE PORQUE RECIEN ACA ES CUANDO SE MANDA A BORRAR!!!!! Se procesaria ese form en un eliminarLogro.php.
  */
...
<div class="row">
  ...
  <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
             <!-- content goes here -->
                <form class="" action="agregarLogro.php" method="get" target="_self" accept-charset="UTF-8" autocomplete="on" name="formlogro">
  ...
  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer" style="border:none;">
          ...
          <form class="form-inline form-eliminar col-md-6" action="eliminarLogro.php" method="get" target="_self" accept-charset="UTF-8" autocomplete="on" name="deletelogroForm">
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
             <!-- content goes here -->
                <form class="form-edit" action="editarLogro.php" method="get" target="_self" accept-charset="UTF-8" autocomplete="on" name="formEdit">
                  <div class="form-group col-md-6">
                    <label><span class="glyphicon glyphicon-bookmark"></span> Nombre:</label>
